...
const apiKey = "b1b4187fe91ad28e7c4c17be4078a0f6"; // 🔑 Sua chave de API do TMDB
...
// 🖼️ Função para exibir os filmes no carrossel de destaques ou mais buscados
...
async function exibirDetalhes(id, tipo) {
  ...
  // 🛠️ Atualiza o conteúdo da seção de detalhes
  detalhe.innerHTML = `
    <div class="detalhes">
...
// 🔁 Função para voltar à tela principal (carrosséis)
function voltar() {
